<template>
  <div v-wechat-title="$route.meta.title"  class="material" style="width: 100px">
    <div class="top">
      <div class="topLeft">
    ...
    <div class="body">
      <div class="bodyTop">
        ...
        <div class="bodyTopRight">
          ...
          <el-button type="primary" style="margin-left: 8px;" @click="add">新建文件夹</el-button>
          <el-button type="primary" style="margin-left: 8px;" @click="load">上传素材</el-button>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    goOn(index){
      console.log(this.tableData[index].fileName)
      this.$router.push({path:"/adminMaterialDetail",query:{name: this.tableData[index].fileName}})
    },
    selectAll(){
